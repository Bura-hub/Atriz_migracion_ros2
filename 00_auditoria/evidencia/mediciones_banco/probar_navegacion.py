...
print()
print('  🔴 EL NÚMERO QUE FALTA LO PONES TÚ: mide con cinta, de centro a centro.')
print('     Si la cinta se parece a la ODOMETRÍA y no a AMCL, AMCL no está')
print('     localizado — y da igual que Nav2 diga que llegó.')
print('  📌 Un |yaw| que crece durante el recorrido es la firma de eso mismo.')
print('=' * 74)
n.destroy_node()
rclpy.shutdown()
