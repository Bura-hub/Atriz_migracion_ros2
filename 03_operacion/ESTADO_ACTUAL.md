...
| `Atriz_rvr` | **`ros2`** ← por defecto desde el 2026-08-04 | público. 🔴 **TRES ramas, no dos** (comprobado el 2026-08-15): `ros2`, `main` (ROS 1, **132** commits detrás, y **su README no avisa de que está obsoleta** — repositorio público) y **`feat/estado-robot`** — del 2026-08-04, **fusionada del todo** (0 commits propios, 54 por detrás) y con las credenciales filtradas en su historial. 👤 Borrarla es higiene barata. `migracion-ros2` y `wip/scripts-estudiantes` **borradas** el 2026-08-03 |
