...
|---|---|---|---|
| `verificar_robot.sh` | cualquiera | no | ✅ **probado en rvr-01** (2026-07-31): **78 sin `--hardware`**, 0 fallos y 3 avisos (2026-07-31, tras añadir la sección 10). El conteo con `--hardware` está **pendiente de re-medir** |
