...
**91 comprobaciones** con `--hardware` (89 sin él) y código de salida ≠ 0 si algo falla. Es lo que hace que 16 robots sean
...
├── verificar_robot.sh        ✅ 91 aserciones: ¿está este robot bien? ← ÚSALO SIEMPRE
